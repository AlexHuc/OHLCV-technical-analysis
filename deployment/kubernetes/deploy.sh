#!/bin/bash
# Deployment script for OHLCV Stock Technical Analysis Service on Minikube

echo "🚀 Deploying OHLCV Stock Technical Analysis Service on Minikube"
...
kubectl wait --for=condition=ready pod -l app=ohlcv-prediction -n ohlcv-prediction --timeout=180s
